...
function removeHighlight() {
  ...
  dice.forEach((die) => {
    die.classList.remove("highlightedDie");
  });
}
...
function reroll(roll, player) {
  if (
    !(roll[0] === 4 && roll[1] === 5 && roll[2] === 6) &&
    !(roll[0] === 1 && roll[1] === 2 && roll[2] === 3)
  ) {
...
function diceImg(num) {
  //return the proper dice image based on the roll
